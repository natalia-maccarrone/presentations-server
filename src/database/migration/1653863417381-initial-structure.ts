...
export class initialStructure1653863417381 implements MigrationInterface {
    name = 'initialStructure1653863417381'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "presentation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "details" character varying NOT NULL, "room" integer NOT NULL, "speaker" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b3d0364e16cd51d8196a13c528d" PRIMARY KEY ("id"))`);
